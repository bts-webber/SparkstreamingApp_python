...
${PYTHON_LIB_PATH}/fastavro.zip,${PYTHON_LIB_PATH}/elasticsearch.zip,\
${PYTHON_LIB_PATH}/urllib3.zip,./avro.py,./es.py,./FromKafkaToEsJob.py,./FromKafkaToKafkaJob.py,./get_ssc.py \
